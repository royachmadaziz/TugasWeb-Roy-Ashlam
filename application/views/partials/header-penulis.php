        ...
        <div class="ui top fixed menu">
            <div class="ui container">
                ...
                <div class="right item">
                    <a class="ui button purple" href="<?php echo base_url('books/create') ?>">Publish Your Book</a>
                    <div class="ui simple dropdown item">
                        ...
                        <div class="menu">
                            ...
                            <div class="ui basic modal">
                                ...
                                <div class="content">
                                    <center>
                                    <img class="ui small circular" src="<?php echo base_url('assets/img/logout1.png') ?>">
                                    </center>
                                </div>
                                <div class="actions">
