...
<body>
	<table>
		<tr>
			...
			<img src="<?php echo base_url('/assets/img/book1.png'); ?>" alt="" align="center" width="100" height="100"> 
			</td>
	...
	<table>
		...
		<p style="text-align: center"><a href="<?php echo base_url()?>index.php/Cetak/cetakBuku/<?php echo $key->kd_buku ?>" class="ui button primary">Cetak PDF</a></p><br>
